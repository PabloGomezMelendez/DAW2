...
public class Contantes {
	...
	public static final String LOGIN_PASSWORD = "INTRODUCE LA CONTRASEÑA: ";
	...
	public static final String[] MENU_INICIO_ACCIONES_USER= {"SALIR","Crear cuenta","Ingresar dinero a cuenta","Retirar dinero de una cuenta","Mover dinero entre cuentas"};
	...
	public static final String SELECIONA_ACCION = "SELECIONA UNA ACCION [Introduce el número de la acción a realizar] : ";
