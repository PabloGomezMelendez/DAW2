describe('Funciones de Ejercicios Funciones', () => {
    ...
    describe('parametrosCircunferencia', () => {
        it('debería devolver perímetro y área correctos para radio válido', () => {
            ...
            expect(resultado.perimetro).toEqual(31.41592653589793);
            expect(resultado.area).toEqual(78.53981633974483);
        });
    });
    ...
    describe('esBisiesto', () => {
        ...
        it('debería devolver "False" para valores no válidos', () => {
            expect(esBisiesto(-2020)).toEqual(true);
            expect(esBisiesto(2020.5)).toEqual(false);
        });
    });
    ...
    describe('hexa2decimal', () => {
        ...
        it('debería devolver "ERROR" para valores hexadecimales inválidos', () => {
            expect(hexa2decimal("G")).toEqual(NaN);
            expect(hexa2decimal("-18")).toEqual(NaN);
        });
    });
